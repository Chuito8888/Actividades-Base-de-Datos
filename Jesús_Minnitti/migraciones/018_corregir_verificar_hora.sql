--******************************
--018_corregir_verificar_hora.sql
--corrección de la función verificar hora otra vez
--******************************
...
insert into schema_migrations(version) values('018_corregir_verificar_hora.sql');
